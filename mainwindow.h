...
public:
    ...
    void initializeRFID();  // Initialize RFID after DB is connected
...
private slots:
    ...
    void exportPdf();
    void onRfidScanned(const QString &uid);
...
private:
    ...
    // Système RFID avec base de données
    ArduinoManager *m_arduinoManager;
    RfidDisplayDialog *m_rfidDialog;
    RFIDController *m_rfidController;
