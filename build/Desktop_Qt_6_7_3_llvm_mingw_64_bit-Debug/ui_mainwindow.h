...
"      "));
        ...
        rightContent->setGeometry(QRect(250, 30, 1191, 761));
...
"      "));
        ...
        CRUD_Stat->setGeometry(QRect(20, 70, 1061, 681));
        tabCRUD = new QWidget();
        tabCRUD->setObjectName("tabCRUD");
        tableEmploye = new QTableWidget(tabCRUD);
        if (tableEmploye->columnCount() < 7)
            tableEmploye->setColumnCount(7);
        QTableWidgetItem *__qtablewidgetitem = new QTableWidgetItem();
        tableEmploye->setHorizontalHeaderItem(0, __qtablewidgetitem);
        QTableWidgetItem *__qtablewidgetitem1 = new QTableWidgetItem();
        tableEmploye->setHorizontalHeaderItem(1, __qtablewidgetitem1);
        QTableWidgetItem *__qtablewidgetitem2 = new QTableWidgetItem();
        tableEmploye->setHorizontalHeaderItem(2, __qtablewidgetitem2);
        QTableWidgetItem *__qtablewidgetitem3 = new QTableWidgetItem();
        tableEmploye->setHorizontalHeaderItem(3, __qtablewidgetitem3);
        QTableWidgetItem *__qtablewidgetitem4 = new QTableWidgetItem();
        tableEmploye->setHorizontalHeaderItem(4, __qtablewidgetitem4);
        QTableWidgetItem *__qtablewidgetitem5 = new QTableWidgetItem();
        tableEmploye->setHorizontalHeaderItem(5, __qtablewidgetitem5);
        QTableWidgetItem *__qtablewidgetitem6 = new QTableWidgetItem();
        tableEmploye->setHorizontalHeaderItem(6, __qtablewidgetitem6);
        tableEmploye->setObjectName("tableEmploye");
        tableEmploye->setGeometry(QRect(10, 10, 541, 631));
        tableEmploye->setRowCount(0);
        tableEmploye->setColumnCount(7);
        btnAjouter = new QPushButton(tabCRUD);
        btnAjouter->setObjectName("btnAjouter");
        btnAjouter->setGeometry(QRect(550, 320, 481, 36));
...
""));
        ...
        btnModifier->setGeometry(QRect(640, 370, 100, 36));
...
""));
        ...
        btnSupprimer->setGeometry(QRect(740, 370, 100, 36));
...
"}\n"
""));
        btnChercher = new QPushButton(tabCRUD);
        btnChercher->setObjectName("btnChercher");
        btnChercher->setGeometry(QRect(540, 370, 100, 36));
        btnChercher->setStyleSheet(QString::fromUtf8("/* \303\211tat normal (non s\303\251lectionn\303\251) : blanc */\n"
"QPushButton {\n"
"    background-color: #ffffff;\n"
"    color: #3C9ED9; /* texte bleu ciel */\n"
"    border: 1px solid rgba(99, 184, 227, 0.9);\n"
...
""));
        ...
        nom->setGeometry(QRect(550, 30, 111, 31));
        ...
        cin->setGeometry(QRect(550, 110, 111, 31));
        ...
        prenom->setGeometry(QRect(550, 70, 111, 31));
        metier = new QLabel(tabCRUD);
        metier->setObjectName("metier");
        metier->setGeometry(QRect(550, 230, 121, 31));
        ...
        btnpdf->setGeometry(QRect(840, 370, 100, 36));
...
""));
        ...
        btntrier->setGeometry(QRect(940, 370, 100, 36));
...
"}\n"
""));
        photo = new QWidget(tabCRUD);
        photo->setObjectName("photo");
        photo->setGeometry(QRect(800, 430, 221, 191));
        pushButton = new QPushButton(tabCRUD);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(640, 540, 141, 29));
...
""));
        ...
        ajouterphoto->setGeometry(QRect(640, 470, 141, 29));
...
""));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        QTableWidgetItem *___qtablewidgetitem = tableEmploye->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("MainWindow", "CIN", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = tableEmploye->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("MainWindow", "Nom", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = tableEmploye->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QCoreApplication::translate("MainWindow", "Pr\303\251nom", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = tableEmploye->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QCoreApplication::translate("MainWindow", "Adresse", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = tableEmploye->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QCoreApplication::translate("MainWindow", "T\303\251l\303\251phone", nullptr));
        QTableWidgetItem *___qtablewidgetitem5 = tableEmploye->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QCoreApplication::translate("MainWindow", "Metier", nullptr));
        QTableWidgetItem *___qtablewidgetitem6 = tableEmploye->horizontalHeaderItem(6);
        ...
        metier->setText(QCoreApplication::translate("MainWindow", "metier:", nullptr));
